...
const lv: SpecGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'TV un internets', description: 'TV un interneta tīklu pieslēgumi katrā dzīvoklī saskaņā ar projektu. Operators SIA Balticom (pircējs slēdz pieslēguma līgumu atsevišķi).' },
...
const ru: SpecGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'ТВ и интернет', description: 'Подключения ТВ и интернета в каждой квартире — по проекту. Оператор SIA Balticom (договор подключения покупатель заключает отдельно).' },
...
const en: SpecGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'TV and internet', description: 'TV and internet connections in every apartment per the project. Operator SIA Balticom (the buyer signs the connection contract separately).' },
